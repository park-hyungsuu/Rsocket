...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<BaseResponseVo> handleValidationExceptions(NoHandlerFoundException ex) {
		log.info("NoHandlerFoundException is happened!  {}" + ex);
		...
		baseResVo.setMessage("NoHandlerFoundException is happened!");
		// Exception시에는 globalFilter에서 처리 못하니 ExceptionHandler에사 MDC 삭제
       	MDC.remove(mdcName);
		return new ResponseEntity<BaseResponseVo>(baseResVo, headers, HttpStatus.OK);
	}
